            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16">
                ...
                @foreach($homeServices as $service)
                    <div class="group bg-white/5 backdrop-blur-sm rounded-[3rem] shadow-[0_20px_50px_rgba(0,0,0,0.1)] border border-white/10 p-16 flex flex-col items-center text-center hover:shadow-[0_40px_80px_rgba(0,0,0,0.2)] hover:-translate-y-4 transition-all duration-700">
                        ...
                        <h5 class="text-2xl font-bold text-white mb-6 font-serif group-hover:text-gold transition-colors">{{ $service['title'] }}</h5>
                        <p class="text-slate-300 font-light leading-relaxed text-sm">{{ $service['desc'] }}</p>
                    </div>
                @endforeach
            </div>

            <div class="mt-32 text-center">
                <a href="{{ route('services') }}" class="inline-flex items-center gap-6 text-gold font-bold uppercase tracking-[0.5em] text-[10px] hover:text-navy transition-colors group">
                            ...
                            <li class="splide__slide px-4">
                                <div class="group bg-white rounded-[3.5rem] overflow-hidden shadow-2xl shadow-navy/5 hover:shadow-navy/20 transition-all duration-1000 flex flex-col h-full hover:-translate-y-4 border border-slate-50">
                                    <div class="relative h-[450px] overflow-hidden">
                                        @if($room->image)
                                            <img src="{{ asset('storage/' . $room->image) }}" alt="{{ $room->name }}" class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-2000">
                                        @else
                                    ...
                                    <div class="p-16 flex flex-col flex-grow relative">
                                        <div class="flex items-center justify-between mb-8">
                                            <h4 class="text-4xl font-serif font-bold text-navy group-hover:text-gold transition-colors">{{ $room->name }}</h4>
