...
<body class="flex flex-col min-h-full font-sans text-slate-900 antialiased bg-slate-50">
    ...
    <!-- Footer -->
    <!-- Footer Start -->
    <footer class="bg-primary-600 text-white mt-auto pt-16 pb-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mb-12">
                <!-- Column 1: Brand & Contact -->
                <div class="space-y-8">
                    <div class="bg-primary-500 rounded-xl p-6 text-center shadow-inner inline-block">
                        <a href="{{ route('home') }}">
                            <h1 class="text-2xl font-serif font-bold text-white uppercase tracking-widest mb-0">Salpat Camp</h1>
                        </a>
                    </div>
                    
                    <div>
                        <h6 class="text-primary-200 font-bold uppercase tracking-wider mb-4 text-sm">Contact</h6>
                        <div class="space-y-4">
                            <p class="flex gap-3 items-start text-sm text-primary-50">
                                ...
                                <span>Falcon Street 1, Soweto Moshi-Kilimanjaro Tanzania</span>
                            </p>
                            <p class="flex gap-3 items-center text-sm text-primary-50">
                                <svg class="w-5 h-5 text-white shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path></svg>
                                <span>+255 0770307759</span>
                            </p>
                            <p class="flex gap-3 items-center text-sm text-primary-50">
                                ...
                                <span>salpatcamp@yahoo.com</span>
                            </p>
                        </div>
                        
                        <div class="flex gap-2 mt-6">
                            <a href="#" class="w-10 h-10 rounded-full border border-primary-300 flex items-center justify-center hover:bg-white hover:text-primary-600 transition-colors"><svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z"/></svg></a>
                            <a href="#" class="w-10 h-10 rounded-full border border-primary-300 flex items-center justify-center hover:bg-white hover:text-primary-600 transition-colors"><svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"/></svg></a>
                            <a href="#" class="w-10 h-10 rounded-full border border-primary-300 flex items-center justify-center hover:bg-white hover:text-primary-600 transition-colors"><svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.5 12 3.5 12 3.5s-7.505 0-9.377.55a3.016 3.016 0 0 0-2.122 2.136C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.55 9.376.55 9.376.55s7.505 0 9.377-.55a3.016 3.016 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg></a>
                            <a href="#" class="w-10 h-10 rounded-full border border-primary-300 flex items-center justify-center hover:bg-white hover:text-primary-600 transition-colors"><svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M4.98 3.5c0 1.381-1.11 2.5-2.48 2.5s-2.48-1.119-2.48-2.5c0-1.38 1.11-2.5 2.48-2.5s2.48 1.12 2.48 2.5zm.02 4.5h-5v16h5v-16zm7.982 0h-4.968v16h4.969v-8.399c0-4.67 6.029-5.052 6.029 0v8.399h4.988v-10.131c0-7.88-8.922-7.593-11.018-3.714v-2.155z"/></svg></a>
                        </div>
                    </div>
                </div>
                ...
                <!-- Column 2: Company -->
                <div>
                    <h6 class="text-primary-200 font-bold uppercase tracking-wider mb-6 text-sm">Company</h6>
                    <ul class="space-y-4">
                        <li><a href="{{ route('about') }}" class="text-sm text-primary-50 hover:text-accent-400 transition flex items-center gap-2">About Us</a></li>
                        <li><a href="{{ route('contact') }}" class="text-sm text-primary-50 hover:text-accent-400 transition flex items-center gap-2">Contact Us</a></li>
                        <li><a href="#" class="text-sm text-primary-50 hover:text-accent-400 transition flex items-center gap-2">Privacy Policy</a></li>
                        <li><a href="#" class="text-sm text-primary-50 hover:text-accent-400 transition flex items-center gap-2">Terms & Condition</a></li>
                        <li><a href="#" class="text-sm text-primary-50 hover:text-accent-400 transition flex items-center gap-2">Support</a></li>
                    </ul>
                </div>

                <!-- Column 3: Services -->
                <div>
                    <h6 class="text-primary-200 font-bold uppercase tracking-wider mb-6 text-sm">Services</h6>
                    <ul class="space-y-4">
                        <li><a href="{{ route('rooms.index') }}" class="text-sm text-primary-50 hover:text-accent-400 transition flex items-center gap-2">Accomodations</a></li>
                        <li><a href="{{ route('services') }}" class="text-sm text-primary-50 hover:text-accent-400 transition flex items-center gap-2">Breakfast</a></li>
                        <li><a href="{{ route('services') }}" class="text-sm text-primary-50 hover:text-accent-400 transition flex items-center gap-2">Lunch and Dinner (on order)</a></li>
                        <li><a href="{{ route('services') }}" class="text-sm text-primary-50 hover:text-accent-400 transition flex items-center gap-2">Soft and hard Drinks</a></li>
                        <li><a href="{{ route('services') }}" class="text-sm text-primary-50 hover:text-accent-400 transition flex items-center gap-2">Free WiFi</a></li>
                        <li><a href="{{ route('services') }}" class="text-sm text-primary-50 hover:text-accent-400 transition flex items-center gap-2">Free Car Parking</a></li>
                    </ul>
                </div>
            </div>

            <!-- Bottom Copyright Row -->
            <div class="border-t border-primary-500 pt-8 mt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                <div class="text-sm text-primary-100 text-center md:text-left leading-relaxed">
                    &copy; <a href="{{ route('home') }}" class="text-white hover:text-accent-400 transition font-medium border-b border-primary-400">Salpat Camp</a>, All Right Reserved.
                    <br class="hidden md:block">
                    <span class="text-xs text-primary-300 mt-2 block">Designed By <a href="https://htmlcodex.com" class="text-primary-100 hover:text-white border-b border-primary-400 inline-block" target="_blank">Salpat Camp</a></span>
                </div>
                <div class="flex flex-wrap justify-center gap-x-6 gap-y-2 text-sm font-medium">
                    <a href="{{ route('home') }}" class="text-primary-100 hover:text-accent-400 transition">Home</a>
                    <a href="#" class="text-primary-100 hover:text-accent-400 transition">Cookies</a>
                    <a href="#" class="text-primary-100 hover:text-accent-400 transition">Help</a>
                    <a href="#" class="text-primary-100 hover:text-accent-400 transition">FQAs</a>
                </div>
            </div>
        </div>
    </footer>
