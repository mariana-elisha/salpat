            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-20 mb-32">
                ...
                <div>
                    ...
                    <ul class="space-y-5 pt-4">
                        @foreach(['Home' => 'home', 'Our Rooms' => 'rooms.index', 'Experiences' => 'gallery', 'Our Story' => 'about', 'Services' => 'services', 'Contact' => 'contact'] as $label => $route)
                            <li>
                                <a href="{{ route($route) }}" class="text-slate-400 hover:text-gold transition-colors font-medium tracking-wide flex items-center group">
