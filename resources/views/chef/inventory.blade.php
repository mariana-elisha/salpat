...
@section('title', 'Chef Inventory')
@section('breadcrumbs', 'Chef / Inventory')
...
<div class="space-y-8" x-data="{ showAddModal: false, showUseModal: false, selectedItem: null, selectedItemName: '', selectedItemMax: 1 }">
    ...
    <div class="flex justify-between items-center bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
        <div>
            ...
            <p class="text-slate-500 text-sm mt-1">Track ingredients and log kitchen usage.</p>
        </div>
                ...
                <form action="{{ route('chef.inventory.store') }}" method="POST" class="p-6">
                    ...
                    <div class="space-y-4 mb-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                <label class="block text-sm font-bold text-slate-700 mb-1">Unit (eg. kg, pcs)</label>
                ...
                <form :action="'{{ url('chef/inventory') }}/' + selectedItem + '/use'" method="POST" class="p-6">
                    ...
                    <div class="space-y-4 mb-6">
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="2" required class="w-full rounded-xl border-slate-200 bg-slate-50 focus:ring-primary-500 focus:border-primary-500" placeholder="e.g., Used for 10 plates of Pilau served to guests."></textarea>
                        </div>
                    </div>
                    <div class="flex justify-end gap-3">
