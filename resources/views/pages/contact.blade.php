                            ...
                            <form action="{{ route('contact.submit') }}" method="POST" class="space-y-16">
                                ...
                                <div class="relative group">
                                    <textarea name="message" id="message" rows="5" required
                                        class="w-full bg-transparent border-b-2 border-slate-200 py-6 text-xl font-serif text-navy focus:outline-none focus:border-gold transition-colors peer placeholder-transparent resize-none">{{ old('message') }}</textarea>
