...
@section('title', 'Concierge & Contact - Salpat Camp Lodge-Moshi')
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-40 relative z-20">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-24">
                ...
                <div class="lg:col-span-8">
                    <div class="bg-creme-dark/50 backdrop-blur-md rounded-[4rem] p-12 md:p-24 shadow-inner border border-white/40 relative animate-slide-up animation-delay-200">
                        <div class="absolute top-0 right-0 w-64 h-64 bg-white rounded-full blur-[100px] opacity-40 -mr-32 -mt-32"></div>
                        ...
                        <div class="relative z-10">
                            ...
                            <form action="{{ route('contact.submit') }}" method="POST" class="space-y-16">
                                @csrf
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-16">
                                    <!-- Name -->
                                    <div class="relative group">
                                        <input type="text" name="name" id="name" value="{{ old('name') }}" required
                                            class="w-full bg-transparent border-b-2 border-navy/10 py-6 text-xl font-serif text-navy focus:outline-none focus:border-gold transition-colors peer placeholder-transparent">
                                        <label for="name" class="absolute left-0 -top-4 text-[9px] font-bold text-slate-400 uppercase tracking-[0.3em] transition-all peer-placeholder-shown:text-xl peer-placeholder-shown:top-6 peer-placeholder-shown:text-slate-400 peer-focus:-top-4 peer-focus:text-gold peer-focus:text-[9px]">Your Name</label>
                                    </div>
                                    ...
                                    <div class="relative group">
                                        <input type="email" name="email" id="email" value="{{ old('email') }}" required
                                            class="w-full bg-transparent border-b-2 border-navy/10 py-6 text-xl font-serif text-navy focus:outline-none focus:border-gold transition-colors peer placeholder-transparent">
                                        <label for="email" class="absolute left-0 -top-4 text-[9px] font-bold text-slate-400 uppercase tracking-[0.3em] transition-all peer-placeholder-shown:text-xl peer-placeholder-shown:top-6 peer-placeholder-shown:text-slate-400 peer-focus:-top-4 peer-focus:text-gold peer-focus:text-[9px]">Your Email</label>
                                    </div>
                                </div>
                                ...
                                <div class="relative group">
                                    <input type="text" name="subject" id="subject" value="{{ old('subject') }}" required
                                        class="w-full bg-transparent border-b-2 border-navy/10 py-6 text-xl font-serif text-navy focus:outline-none focus:border-gold transition-colors peer placeholder-transparent">
                                    <label for="subject" class="absolute left-0 -top-4 text-[9px] font-bold text-slate-400 uppercase tracking-[0.3em] transition-all peer-placeholder-shown:text-xl peer-placeholder-shown:top-6 peer-placeholder-shown:text-slate-400 peer-focus:-top-4 peer-focus:text-gold peer-focus:text-[9px]">Subject</label>
                                </div>

                                <!-- Message -->
                                <div class="relative group">
                                    <textarea name="message" id="message" rows="5" required
                                        class="w-full bg-transparent border-b-2 border-navy/10 py-6 text-xl font-serif text-navy focus:outline-none focus:border-gold transition-colors peer placeholder-transparent resize-none">{{ old('message') }}</textarea>
                                    <label for="message" class="absolute left-0 -top-4 text-[9px] font-bold text-slate-400 uppercase tracking-[0.3em] transition-all peer-placeholder-shown:text-xl peer-placeholder-shown:top-6 peer-placeholder-shown:text-slate-400 peer-focus:-top-4 peer-focus:text-gold peer-focus:text-[9px]">How may we serve you?</label>
                                </div>
