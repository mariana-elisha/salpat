...
$storageGalleriesDir = storage_path('app/public/galleries');

if (!File::exists($storageGalleriesDir)) {
    File::makeDirectory($storageGalleriesDir, 0755, true);
}
...
foreach ($images as $filename) {
    ...
    $destinationPath = $storageGalleriesDir . '/' . $filename;
