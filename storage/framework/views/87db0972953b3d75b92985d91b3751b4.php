...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-span-full sm:col-span-3">
                            ...
                            <?php if($room->image): ?>
                                <div class="mt-2 mb-4">
                                    <img src="<?php echo e(asset('storage/' . $room->image)); ?>" alt="Current Image"
                            ...
                            <?php if($room->images && count($room->images) > 0): ?>
                                <div class="mt-2 mb-4 flex gap-2 flex-wrap">
                                    <?php $__currentLoopData = $room->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="relative">
                                            <img src="<?php echo e(asset('storage/' . $img)); ?>" alt="Additional Image" class="h-20 w-20 object-cover rounded shadow-sm border border-slate-200">
                                            <!-- In a full implementation, add an AJAX endpoint to delete individual images. For now we just show them. -->
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
...
<?php echo $__env->make('layouts.panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\salpat\resources\views/admin/rooms/edit.blade.php ENDPATH**/ ?>