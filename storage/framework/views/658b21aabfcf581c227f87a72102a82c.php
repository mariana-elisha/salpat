                ...
                <?php $__currentLoopData = $homeServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="group p-10 rounded-[2.5rem] bg-creme-dark/30 hover:bg-white hover:shadow-4xl transition-all duration-700 border border-transparent hover:border-gold/10">
                        <div class="w-16 h-16 bg-navy text-gold rounded-2xl flex items-center justify-center mb-8 transition-all duration-700 group-hover:bg-gold group-hover:text-white shadow-lg">
                            <i class="fas fa-<?php echo e($service['icon']); ?> text-xl"></i>
                        </div>
                        <h5 class="text-2xl font-bold text-navy mb-6 font-serif"><?php echo e($service['title']); ?></h5>
                        <p class="text-slate-500 font-light leading-relaxed text-sm"><?php echo e($service['desc']); ?></p>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
            ...
            <div class="flex flex-col lg:flex-row items-center gap-24">
                <div class="w-full lg:w-1/2 space-y-12">
                    ...
                    <div class="pt-8 flex flex-wrap gap-6">
                        <a href="<?php echo e(route('services')); ?>" class="px-10 py-5 bg-navy text-white rounded-2xl font-bold uppercase tracking-widest text-[10px] hover:bg-gold transition-colors">View Full Menu</a>
                        <a href="<?php echo e(route('contact')); ?>" class="px-10 py-5 border border-navy/10 text-navy rounded-2xl font-bold uppercase tracking-widest text-[10px] hover:border-gold hover:text-gold transition-colors">Book a Table</a>
                    </div>
                </div>
                ...
                <div class="splide__track">
                    <ul class="splide__list">
                            ...
                            <li class="splide__slide px-4">
                                <div class="bg-white p-12 md:p-16 rounded-[3rem] shadow-2xl shadow-navy/5 border border-slate-50 flex flex-col h-full relative">
                                    ...
                                    <p class="text-slate-600 font-light leading-relaxed text-lg italic mb-12 flex-grow overflow-hidden">
                                        "<?php echo e($testimonial->comments); ?>"
                                    </p>
                                    <div class="flex items-center gap-6 mt-auto pt-8 border-t border-slate-50">
                                        <div class="w-12 h-12 bg-creme-dark rounded-full flex items-center justify-center text-navy font-bold text-lg font-serif">
                                            <?php echo e(substr($testimonial->guest_name, 0, 1)); ?>

                                        </div>
                                        <div>
                                            <p class="text-navy font-bold text-sm tracking-widest uppercase"><?php echo e($testimonial->guest_name); ?></p>
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            ...
                            ?>
                            <?php $__currentLoopData = $staticTestimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="splide__slide px-4">
                                    <div class="bg-white p-12 md:p-16 rounded-[3rem] shadow-2xl shadow-navy/5 border border-slate-50 flex flex-col h-full relative">
                                        <div class="flex gap-1 mb-8 text-gold">
                                            <i class="fas fa-star text-[10px]"></i>
                                        ...
                                        <p class="text-slate-600 font-light leading-relaxed text-lg italic mb-12 flex-grow">
                                            "<?php echo e($st['comment']); ?>"
                                        </p>
                                        <div class="flex items-center gap-6 mt-auto pt-8 border-t border-slate-50">
                                            <div class="w-12 h-12 bg-creme-dark rounded-full flex items-center justify-center text-navy font-bold text-lg font-serif">
                                                <?php echo e(substr($st['name'], 0, 1)); ?>

                                            </div>
                                            <div>
                                                <p class="text-navy font-bold text-sm tracking-widest uppercase"><?php echo e($st['name']); ?></p>
                                                <p class="text-gold font-bold text-[9px] uppercase tracking-widest mt-1"><?php echo e($st['loc']); ?></p>
                                            </div>
                                        </div>
                                        <i class="fas fa-quote-right absolute top-12 right-12 text-5xl text-gold/5"></i>
                                    </div>
