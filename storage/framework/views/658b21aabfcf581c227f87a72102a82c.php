            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
                ...
                <div class="relative group">
                    <div class="relative rounded-[4rem] overflow-hidden shadow-4xl group-hover:scale-105 transition-transform duration-[2s]">
                        <img src="<?php echo e(asset('images/pcs3.jpeg')); ?>" alt="Salpat Dining" class="w-full h-[700px] object-cover">
                            ...
                            <li class="splide__slide px-4">
                                <div class="group bg-white rounded-[3.5rem] overflow-hidden shadow-2xl shadow-navy/5 hover:shadow-navy/20 transition-all duration-1000 flex flex-col h-full hover:-translate-y-4 border border-slate-50">
                                    <div class="relative h-[450px] overflow-hidden">
                                        <?php if($room->image): ?>
                                            <img src="<?php echo e(asset('storage/' . $room->image)); ?>" alt="<?php echo e($room->name); ?>" class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-2000">
                                        <?php else: ?>
                                    ...
                                    <div class="p-16 flex flex-col flex-grow relative">
                                        <div class="flex items-center justify-between mb-8">
                                            <h4 class="text-4xl font-serif font-bold text-navy group-hover:text-gold transition-colors"><?php echo e($room->name); ?></h4>
