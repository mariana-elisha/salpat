            ...
            <div class="bg-white/10 backdrop-blur-xl border border-white/10 p-8 sm:p-10 rounded-3xl shadow-2xl relative overflow-hidden group">
                ...
                <?php if($errors->any()): ?>
                    <div class="bg-rose-500/10 border border-rose-500/20 rounded-2xl p-4 mb-8 flex items-start gap-3 animate-shake">
                        ...
                        <p class="text-sm font-bold text-rose-200"><?php echo e($errors->first()); ?></p>
                    </div>
                <?php endif; ?>
                ...
                <?php if(session('status') || session('success')): ?>
                    <div class="bg-emerald-500/10 border border-emerald-500/20 rounded-2xl p-4 mb-8 flex items-start gap-3">
                        ...
                        <p class="text-sm font-bold text-emerald-200"><?php echo e(session('status') ?? session('success')); ?></p>
                    </div>
                <?php endif; ?>
                ...
                <form class="space-y-6" action="<?php echo e(route('login')); ?>" method="POST">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input id="email" name="email" type="email" autocomplete="off" required value="<?php echo e(old('email')); ?>" 
                    ...
                    <div class="space-y-1.5">
                        <div class="flex justify-between items-center px-1">
                            ...
                            <a href="<?php echo e(route('password.request')); ?>" class="text-[10px] font-bold text-primary-400 hover:text-primary-300 uppercase tracking-tighter transition-colors">Forgot?</a>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\salpat\resources\views/auth/login.blade.php ENDPATH**/ ?>