...
<body class="flex flex-col min-h-full font-sans text-slate-900 antialiased bg-creme" x-data="{ scrolled: false }" @scroll.window="scrolled = (window.pageYOffset > 50)">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full">
            <div class="flex justify-between items-center h-full min-h-[80px]">
                <div class="flex items-center">
                    <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-8 group">
    ...
    <footer class="bg-navy text-white pt-40 pb-20 mt-20 border-t border-white/5 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-20 lg:gap-12 mb-32">
                ...
                <div>
                    ...
                    <nav class="flex flex-col gap-6">
                        <?php $__currentLoopData = ['Home' => 'home', 'Rooms' => 'rooms.index', 'Experiences' => 'gallery', 'About' => 'about', 'Services' => 'services', 'Contact' => 'contact']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label => $route): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route($route)); ?>" class="text-slate-400 hover:text-white transition-all font-bold uppercase tracking-[0.3em] text-[9px] flex items-center gap-3 group">
                ...
                <div>
                    ...
                    <div class="flex flex-wrap gap-4">
                        <?php $__currentLoopData = ['facebook-f', 'instagram', 'twitter', 'linkedin-in']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $social): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="flex flex-col md:flex-row justify-between items-center pt-16 border-t border-white/5 gap-8">
                <p class="text-slate-500 text-[9px] font-bold uppercase tracking-[0.2em]">&copy; <?php echo e(date('Y')); ?> Salpat Camp Lodge. A Boutique Experience.</p>
    ...
    <div class="booking-bar-float group" x-data="{ show: false }" x-init="window.addEventListener('scroll', () => { show = window.pageYOffset > 400 })" x-show="show" x-cloak x-transition:enter="transition ease-out duration-500" x-transition:enter-start="opacity-0 translate-y-20" x-transition:enter-end="opacity-100 translate-y-0">
        ...
        <div class="flex items-center gap-4">
            ...
            <a href="<?php echo e(route('rooms.index')); ?>" class="bg-gold hover:bg-gold-dark text-white px-10 py-4 rounded-xl text-[10px] font-bold uppercase tracking-[0.2em] shadow-xl transition-all hover:-translate-y-1">
                CHECK AVAILABILITY
            </a>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\salpat\resources\views/layouts/app.blade.php ENDPATH**/ ?>