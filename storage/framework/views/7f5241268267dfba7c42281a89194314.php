...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Salpat Camp'); ?> - <?php echo e(config('app.name', 'Laravel')); ?></title>
                            ...
                            <div x-show="open" x-cloak
                                ...
                                <div class="max-h-60 overflow-y-auto">
                                    <?php $__empty_1 = true; $__currentLoopData = auth()->user()->unreadNotifications->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <div
                                            class="px-4 py-3 text-sm hover:bg-slate-50 <?php echo e($loop->last ? '' : 'border-b border-slate-50'); ?>">
                            ...
                            <div x-show="open" x-transition:enter="transition ease-out duration-100"
                                ...
                                <?php elseif(Auth::user()->isReceptionist()): ?>
                                    ...
                                    <a href="<?php echo e(route('receptionist.reports.index')); ?>"
                                        class="block px-4 py-2 text-sm text-slate-700 hover:bg-slate-50">Reports</a>
                                    <a href="<?php echo e(route('receptionist.contact_messages.index')); ?>"
                                        class="block px-4 py-2 text-sm text-slate-700 hover:bg-slate-50">Contact Messages</a>
                                    <a href="<?php echo e(route('staff_reports.index')); ?>"
                                        class="block px-4 py-2 text-sm text-slate-700 hover:bg-slate-50">Section Reports</a>
            ...
            <div class="border-t border-sky-400 pb-3 pt-4">
                <?php if(auth()->guard()->check()): ?>
                    <div class="flex items-center px-4">
                        <div class="ml-3">
                            <div class="text-base font-bold text-slate-900"><?php echo e(Auth::user()->name); ?></div>
                            <div class="text-sm font-medium text-slate-700"><?php echo e(Auth::user()->email); ?></div>
                        </div>
                    </div>
...
<li><a href="<?php echo e(route('rooms.index')); ?>"
...
<!-- Column 3: Contact Info -->
            ...
            <div
                ...
                <div class="text-sm text-slate-500 text-center md:text-left font-medium">
                    &copy; <?php echo e(date('Y')); ?> <span class="text-white">Salpat Camp</span>. All Rights Reserved.
                </div>
