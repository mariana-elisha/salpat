...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin Panel'); ?> - <?php echo e(config('app.name', 'Salpat Camp')); ?></title>
    ...
    <link href="<?php echo e(asset('css/theme.css')); ?>?v=4" rel="stylesheet">
...
<body class="h-full font-sans antialiased text-slate-300 bg-slate-950 selection:bg-primary-500/30 selection:text-white" x-data="{ sidebarOpen: false }">
    ...
    <div x-show="sidebarOpen" x-transition:enter="transition ease-in-out duration-300 transform"
        ...
        <div class="flex h-16 shrink-0 items-center gap-4">
            <img src="<?php echo e(asset('images/logo.png')); ?>?v=<?php echo e(time()); ?>" alt="Salpat Camp Logo"
            ...
            <ul role="list" class="flex flex-1 flex-col gap-y-7">
                <li>
                    <ul role="list" class="-mx-2 space-y-1">
                        <?php echo $__env->make('layouts.partials.sidebar-nav', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </ul>
                </li>
            </ul>
        </nav>
                        ...
                        <ol role="list" class="flex items-center space-x-2">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <span class="ml-2 text-xs font-black text-white uppercase tracking-widest bg-white/5 px-3 py-1 rounded-lg border border-white/10 shadow-inner"><?php echo $__env->yieldContent('breadcrumbs'); ?></span>
                                </div>
                            </li>
                        </ol>
                    </nav>
                        ...
                        <button type="button" @click="open = !open" @click.away="open = false"
                            ...
                            <?php if(auth()->user()->unreadNotifications->count() > 0): ?>
                                <span class="absolute top-2 right-2 flex h-4 w-4">
                                    ...
                                    <span
                                        class="relative inline-flex rounded-full h-4 w-4 bg-primary-500 text-[10px] items-center justify-center text-white font-black"><?php echo e(auth()->user()->unreadNotifications->count()); ?></span>
                                </span>
                            <?php endif; ?>
                        </button>
                        ...
                        <div x-show="open" x-transition:enter="transition ease-out duration-100"
                            ...
                            <div class="max-h-96 overflow-y-auto">
                                <?php $__empty_1 = true; $__currentLoopData = auth()->user()->notifications->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div
                                        class="px-5 py-4 hover:bg-white/5 transition-all <?php echo e($notification->unread() ? 'bg-primary-500/5 border-l-2 border-primary-500' : ''); ?>">
                                        <div class="flex items-start gap-4">
                                            <div class="flex-1 min-w-0">
                                                <p
                                                    class="text-[13px] leading-relaxed text-slate-200 <?php echo e($notification->unread() ? 'font-bold' : ''); ?>">
                                            ...
                                            <?php if($notification->unread()): ?>
                                                <form action="<?php echo e(route('notifications.read', $notification->id)); ?>"
                                                    method="POST">
                                                    <?php echo csrf_field(); ?>
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" x-transition:enter="transition ease-out duration-100"
                            ...
                            <div class="px-4 py-3 border-b border-slate-800 mb-1 bg-slate-800/30">
                                ...
                                <p class="text-xs font-bold truncate text-white mt-0.5 tracking-tight"><?php echo e(auth()->user()->email); ?></p>
                            </div>
                ...
                <?php if(session('success')): ?>
                    <div class="mb-8 rounded-2xl bg-emerald-500/10 p-5 border border-emerald-500/20 shadow-[0_0_20px_rgba(16,185,129,0.15)] animate-fade-in">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <p class="text-sm font-bold text-emerald-100"><?php echo e(session('success')); ?></p>
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
                ...
                <?php if(session('error')): ?>
                    <div class="mb-8 rounded-2xl bg-red-500/10 p-5 border border-red-500/20 shadow-[0_0_20px_rgba(239,68,68,0.15)] animate-fade-in">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <p class="text-sm font-bold text-red-100"><?php echo e(session('error')); ?></p>
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
...
</html><?php /**PATH C:\xampp\htdocs\sallpat\resources\views/layouts/panel.blade.php ENDPATH**/ ?>