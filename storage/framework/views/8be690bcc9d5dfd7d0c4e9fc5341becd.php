...
<?php $__env->startSection('title', 'Login - Salpat Camp Lodge-Moshi'); ?>
    ...
    <div class="min-h-screen flex items-center justify-center py-20 px-4 sm:px-6 lg:px-8 bg-black relative overflow-hidden">
        ...
        <div class="max-w-xl w-full space-y-12 relative z-10 animate-slide-up">
            ...
            <div class="bg-white/[0.03] backdrop-blur-3xl border border-white/10 p-12 md:p-20 rounded-[4rem] shadow-4xl relative overflow-hidden group">
                ...
                <?php if($errors->any()): ?>
                    <div class="bg-rose-500/10 border-l-4 border-rose-500 rounded-r-2xl p-6 mb-12 flex items-center gap-4 animate-shake">
                        ...
                        <p class="text-[10px] font-bold text-rose-200 uppercase tracking-widest"><?php echo e($errors->first()); ?></p>
                    </div>
                <?php endif; ?>

                <form class="space-y-12" action="<?php echo e(route('login')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <!-- Identity -->
                    <div class="space-y-4">
                    ...
                    <div class="space-y-4">
                        <div class="flex justify-between items-center px-2">
                            ...
                            <a href="<?php echo e(route('password.request')); ?>" class="text-[9px] font-bold text-slate-500 hover:text-gold uppercase tracking-widest transition-colors">Forgot Password?</a>
                        </div>
                        <div class="relative group">
                            <div class="absolute left-6 top-1/2 -translate-y-1/2 text-slate-500 group-focus-within:text-gold transition-colors">
            ...
            <div class="text-center pt-8">
                <a href="<?php echo e(route('home')); ?>" class="text-slate-500 hover:text-gold text-[10px] font-bold uppercase tracking-[0.4em] transition-all flex items-center justify-center gap-3 italic">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sallpat\resources\views/auth/login.blade.php ENDPATH**/ ?>