                                ...
                                <td class="whitespace-nowrap px-6 py-4">
                                    <?php if($room->image): ?>
                                        <img class="h-10 w-10 rounded-full object-cover"
                                            src="<?php echo e(asset('storage/' . $room->image)); ?>" alt="<?php echo e($room->name); ?>">
                                    <?php else: ?>
...
<?php echo $__env->make('layouts.panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\salpat\resources\views/admin/rooms/index.blade.php ENDPATH**/ ?>