    ...
    <div class="relative h-[85vh] min-h-[700px] w-full overflow-hidden bg-navy group" 
        ...
        <template x-for="(img, index) in images" :key="index">
            <div class="absolute inset-0 w-full h-full" x-show="activeImage === index" 
                ...
                <img :src="'<?php echo e(asset('images')); ?>/' + img" :alt="'<?php echo e($room->name); ?> image ' + (index + 1)"
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                <div class="space-y-6 max-w-4xl">
                    <div class="flex items-center gap-4 animate-fade-in">
                        ...
                        <span class="text-gold font-bold uppercase tracking-[0.4em] text-[10px]"><?php echo e($room->type); ?> Collection</span>
                    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-16">
                ...
                <div class="bg-white rounded-[3rem] p-10 md:p-12 shadow-2xl border border-slate-50 flex flex-col md:flex-row justify-between items-start md:items-center gap-10">
                    <div class="text-left">
                        <nav class="flex mb-6 text-[10px] font-bold uppercase tracking-[0.3em] text-slate-400 gap-3">
                            <a href="<?php echo e(route('home')); ?>" class="hover:text-gold transition-colors">The Camp</a>
                            <span class="text-gold/30">/</span>
                            <a href="<?php echo e(route('rooms.index')); ?>" class="hover:text-gold transition-colors">Sanctuaries</a>
                        </nav>
                    ...
                    <div class="text-left md:text-right bg-navy p-8 rounded-[2rem] text-white min-w-[240px] shadow-xl shadow-navy/20 relative overflow-hidden">
                        ...
                        <div class="flex items-baseline justify-start md:justify-end gap-2">
                            <span class="text-5xl font-serif font-bold text-white">$<?php echo e(number_format($room->price_per_night, 0)); ?></span>
                        ...
                        <div class="mt-4 pt-4 border-t border-white/10 text-[10px] font-bold text-gold/80 uppercase tracking-widest text-left md:text-right">
                            Resident: TZS <?php echo e(number_format($room->resident_price_per_night, 0)); ?>
                        ...
                        <section>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
                                ...
                                <div class="flex items-center gap-6 group">
                                    ...
                                    <span class="text-[11px] font-bold uppercase tracking-[0.2em] text-slate-600 group-hover:text-navy transition-colors text-left"><?php echo e($amenity); ?></span>
                                </div>
            ...
            <div class="lg:col-span-1">
                <div class="sticky top-24 space-y-10"
                     x-data="{
                        ...
                        guests: 1,
                         ...
                         get totalUSD() {
                            ...
                            return nights * <?php echo e($room->price_per_night); ?>;
                         },
                         get whatsappUrl() {
                    ...
                    <div class="bg-white rounded-[3rem] shadow-2xl border border-slate-50 overflow-hidden transform hover:scale-[1.02] transition-transform duration-500">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sallpat\resources\views/rooms/show.blade.php ENDPATH**/ ?>