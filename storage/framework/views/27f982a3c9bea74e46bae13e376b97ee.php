<?php $__env->startSection('title', 'Gallery - Salpat Luxury Experiences'); ?>
    ...
    <div class="bg-white min-h-screen">
        ...
        <section class="relative h-[65vh] min-h-[500px] flex items-center justify-center bg-navy overflow-hidden">
            ...
            <div class="absolute inset-0 z-0 text-center">
                <div class="absolute inset-0 w-full h-full bg-cover bg-center transition-opacity duration-1000" style="background-image: url('<?php echo e(asset('images/pcs1.jpeg')); ?>'); opacity: 0.3;"></div>
            </div>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $galleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gallery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <li class="splide__slide px-4">
                                <div class="group relative overflow-hidden rounded-[4rem] shadow-4xl bg-navy h-[700px] border border-white/5">
                                    <img src="<?php echo e(asset('images/' . $gallery->image_path)); ?>" 
                                        onerror="this.src='<?php echo e(asset('images/pcs1.jpeg')); ?>'"
                                    ...
                                    <div class="absolute inset-0 p-16 md:p-24 flex flex-col justify-end transform translate-y-8 group-hover:translate-y-0 transition-all duration-1000">
                                        ...
                                        <h3 class="text-white text-5xl md:text-7xl font-serif font-bold transition-colors delay-200 group-hover:text-gold leading-none"><?php echo e($gallery->title); ?></h3>
                                    </div>
                                </div>
                            </li>
