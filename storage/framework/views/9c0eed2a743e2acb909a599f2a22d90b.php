<?php $__env->startSection('title', 'Salpat Camp Lodge-Moshi - Luxury Sanctuary in Kilimanjaro'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="relative h-screen min-h-[700px] flex items-center justify-center bg-navy overflow-hidden">
        ...
        <div id="hero-slideshow" class="absolute inset-0 z-0">
            <div class="absolute inset-0 w-full h-full bg-cover bg-center transition-opacity duration-1000" style="background-image: url('<?php echo e(asset('images/pcs1.jpeg')); ?>'); opacity: 0.5;"></div>
        </div>
        ...
        <div class="relative z-20 text-center px-4 max-w-5xl mx-auto mt-20">
            ...
            <div class="animate-slide-up-fade animation-delay-1200 mt-12">
                <a href="<?php echo e(route('rooms.index')); ?>" class="bg-gold hover:bg-gold-dark text-white px-12 py-5 rounded-2xl font-bold uppercase tracking-[0.3em] text-[10px] transition-all shadow-2xl shadow-gold/30 hover:-translate-y-1 active:scale-95 inline-block">
                    Discover Our Rooms
                </a>
            </div>
        </div>
    ...
    <section id="booking-anchor" class="relative z-30 -mt-20 max-w-7xl mx-auto px-4 lg:px-8">
        <div class="bg-white rounded-[3rem] shadow-[0_40px_100px_rgba(11,16,33,0.15)] p-4 md:p-6 border border-slate-100 backdrop-blur-3xl">
            <form action="<?php echo e(route('rooms.index')); ?>" method="GET" class="flex flex-col lg:flex-row items-stretch gap-4">
                <div class="flex-grow grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div class="bg-slate-50 group hover:bg-gold/5 transition-colors p-6 rounded-2xl border border-transparent hover:border-gold/20">
                        ...
                        <input type="date" name="check_in" value="<?php echo e(request('check_in')); ?>" min="<?php echo e(date('Y-m-d')); ?>" required
                    ...
                    <div class="bg-slate-50 group hover:bg-gold/5 transition-colors p-6 rounded-2xl border border-transparent hover:border-gold/20">
                        ...
                        <input type="date" name="check_out" value="<?php echo e(request('check_out')); ?>" min="<?php echo e(date('Y-m-d', strtotime('+1 day'))); ?>" required
                               class="w-full bg-transparent border-0 p-0 text-navy focus:ring-0 text-xl font-serif font-bold cursor-pointer">
                    </div>
                    <div class="bg-slate-50 group hover:bg-gold/5 transition-colors p-6 rounded-2xl border border-transparent hover:border-gold/20">
                        ...
                        <select name="guests" class="w-full bg-transparent border-0 p-0 text-navy focus:ring-0 text-xl font-serif font-bold appearance-none cursor-pointer">
                            <?php for($i = 1; $i <= 10; $i++): ?>
                                <option value="<?php echo e($i); ?>" <?php echo e(request('guests', 1) == $i ? 'selected' : ''); ?>><?php echo e($i); ?> <?php echo e(Str::plural('Guest', $i)); ?></option>
                            <?php endfor; ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="lg:w-64 bg-slate-50 group hover:bg-gold/5 transition-colors p-6 rounded-2xl border border-transparent hover:border-gold/20">
                    ...
                    <select name="room_type" class="w-full bg-transparent border-0 p-0 text-navy focus:ring-0 text-sm font-serif font-bold appearance-none cursor-pointer">
                        ...
                        <?php $__currentLoopData = $roomTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($type); ?>" <?php echo e(request('room_type') == $type ? 'selected' : ''); ?>><?php echo e($type); ?></option>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-16">
                ...
                <div class="group text-center">
                    ...
                    <h4 class="text-2xl font-serif font-bold text-navy mb-4">Premium Accommodation</h4>
                    <p class="text-slate-500 font-light leading-relaxed px-4">Relax in meticulously designed rooms that prioritize your comfort after a long day of adventuring.</p>
                </div>
                <!-- Feature 2 -->
                <div class="group text-center">
                    <div class="w-20 h-20 mx-auto mb-8 bg-slate-50 text-gold rounded-3xl flex items-center justify-center transition-all duration-300 group-hover:bg-gold group-hover:text-white group-hover:-translate-y-2 shadow-sm">
                    ...
                    <h4 class="text-2xl font-serif font-bold text-navy mb-4">Exquisite Dining</h4>
                    <p class="text-slate-500 font-light leading-relaxed px-4">Savor locally inspired dishes and international cuisine crafted by our expert resident chefs.</p>
                </div>
                <!-- Feature 3 -->
                <div class="group text-center">
                    <div class="w-20 h-20 mx-auto mb-8 bg-slate-50 text-gold rounded-3xl flex items-center justify-center transition-all duration-300 group-hover:bg-gold group-hover:text-white group-hover:-translate-y-2 shadow-sm">
                    ...
                    <h4 class="text-2xl font-serif font-bold text-navy mb-4">Strategic Location</h4>
                    <p class="text-slate-500 font-light leading-relaxed px-4">Perfectly situated in Moshi, offering easy access to Kilimanjaro and beautiful city environments.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
                <div class="relative group">
                    <div class="relative rounded-[3.5rem] overflow-hidden shadow-4xl border-8 border-white group-hover:-translate-y-4 transition-all duration-1000">
                        <img src="<?php echo e(asset('images/pcs17.png')); ?>" alt="Salpat Lodge Story" class="w-full h-[600px] object-cover scale-105 group-hover:scale-100 transition-transform duration-[3s]">
                ...
                <div class="space-y-12">
                    ...
                    <div class="pt-8">
                        <a href="<?php echo e(route('about')); ?>" class="inline-flex items-center gap-6 text-gold font-bold uppercase tracking-[0.5em] text-[10px] hover:text-navy transition-colors group">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
                <div class="space-y-12">
                    ...
                    <div class="grid grid-cols-2 gap-10">
                        <div class="space-y-4">
                            <h4 class="text-navy font-bold uppercase tracking-widest text-xs">Signature Lounge</h4>
                            <p class="text-[10px] text-slate-400 leading-relaxed">Enjoy a variety of drinks and wines in a relaxing and comfortable place.</p>
                        </div>
                        <div class="space-y-4">
                            <h4 class="text-navy font-bold uppercase tracking-widest text-xs">Garden Terrace</h4>
                            <p class="text-[10px] text-slate-400 leading-relaxed">Dine outside with beautiful views of Mount Kilimanjaro and the hills.</p>
                        </div>
                    </div>
                </div>
                <div class="relative group">
                            ...
                            <ul class="splide__list">
                                <li class="splide__slide">
                                    <div class="relative h-[700px]">
                                        <img src="<?php echo e(asset('images/pcs3.jpeg')); ?>" class="w-full h-full object-cover">
                                        <div class="absolute inset-0 bg-navy/20"></div>
                                    </div>
                                </li>
                                <li class="splide__slide">
                                    <div class="relative h-[700px]">
                                        <img src="<?php echo e(asset('images/pcs15.jpeg')); ?>" class="w-full h-full object-cover">
                                        <div class="absolute inset-0 bg-navy/20"></div>
                                    </div>
                                </li>
                                <li class="splide__slide">
                                    <div class="relative h-[700px]">
                                        <img src="<?php echo e(asset('images/pcs1.jpeg')); ?>" class="w-full h-full object-cover">
                                        <div class="absolute inset-0 bg-navy/20"></div>
                                    </div>
                                </li>
                                <li class="splide__slide">
                                    <div class="relative h-[700px]">
                                        <img src="<?php echo e(asset('images/pcs14.png')); ?>" class="w-full h-full object-cover">
                                        <div class="absolute inset-0 bg-navy/20"></div>
                                    </div>
                                </li>
                            </ul>
    ...
    <section class="py-40 bg-navy relative overflow-hidden">
        <div class="absolute inset-0 z-0">
            <img src="<?php echo e(asset('images/pcs16.png')); ?>" alt="Background" class="w-full h-full object-cover opacity-10">
            <div class="absolute inset-0 bg-navy/60"></div>
        </div>
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="text-center mb-32">
                <h2 class="text-gold font-bold uppercase tracking-[0.5em] text-[10px] mb-6">Our Offerings</h2>
                <h3 class="text-5xl md:text-7xl font-serif font-bold text-white">Premier <span class="italic font-normal text-gold">Services</span></h3>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16">
                <?php
                    $homeServices = [
                        ...
                        ['icon' => 'shield-alt', 'title' => '24/7 Security', 'desc' => 'A fully secured sanctuary with professional guards for your absolute peace of mind.'],
                        ['icon' => 'utensils', 'title' => 'Dining Art', 'desc' => 'Free breakfast is included in your room fee. Lunch and dinner are made on order by our chefs.'],
                ...
                <?php $__currentLoopData = $homeServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="group bg-white/5 backdrop-blur-sm rounded-[3rem] shadow-[0_20px_50px_rgba(0,0,0,0.1)] border border-white/10 p-16 flex flex-col items-center text-center hover:shadow-[0_40px_80px_rgba(0,0,0,0.2)] hover:-translate-y-4 transition-all duration-700">
                        <div class="w-20 h-20 bg-white/5 text-gold rounded-2xl flex items-center justify-center mb-10 transition-all duration-700 group-hover:bg-gold group-hover:text-white group-hover:rotate-[360deg] shadow-sm border border-white/10">
                            <i class="fas fa-<?php echo e($service['icon']); ?> text-2xl"></i>
                        </div>
                        <h5 class="text-2xl font-bold text-white mb-6 font-serif group-hover:text-gold transition-colors"><?php echo e($service['title']); ?></h5>
                        <p class="text-slate-300 font-light leading-relaxed text-sm"><?php echo e($service['desc']); ?></p>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>

            <div class="mt-32 text-center">
                <a href="<?php echo e(route('services')); ?>" class="inline-flex items-center gap-6 text-gold font-bold uppercase tracking-[0.5em] text-[10px] hover:text-navy transition-colors group">
    ...
    <section class="py-40 bg-slate-50 relative overflow-hidden bg-[url('https://www.transparenttextures.com/patterns/graphy-very-light.png')]">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="flex flex-col md:flex-row justify-between items-end mb-32 gap-12">
                ...
                <a href="<?php echo e(route('rooms.index')); ?>" class="group flex items-center gap-8 bg-white px-12 py-6 rounded-2xl shadow-xl hover:bg-navy hover:text-white transition-all duration-700">
                            ...
                            <li class="splide__slide px-4">
                                <div class="group bg-white rounded-[3.5rem] overflow-hidden shadow-2xl shadow-navy/5 hover:shadow-navy/20 transition-all duration-1000 flex flex-col h-full hover:-translate-y-4 border border-slate-50">
                                    <div class="relative h-[450px] overflow-hidden">
                                        <?php if($room->image): ?>
                                            <img src="<?php echo e(asset('images/' . $room->image)); ?>" alt="<?php echo e($room->name); ?>" class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-2000">
                                        <?php else: ?>
                                    ...
                                    <div class="p-8 md:p-12 flex flex-col flex-grow relative">
                                        <div class="flex items-center justify-between mb-8 border-l-4 border-gold pl-6">
                                            <h4 class="text-3xl md:text-4xl font-serif font-bold text-navy group-hover:text-gold transition-colors"><?php echo e($room->name); ?></h4>
                                            <div class="w-12 h-px bg-gold/10"></div>
                                        </div>
                                        
                                        <div class="flex items-baseline gap-3 mb-10">
                                            <span class="text-4xl font-serif font-bold text-navy">$<?php echo e(number_format($room->price_per_night, 0)); ?></span>
                                            <span class="text-[10px] font-bold text-slate-400 uppercase tracking-[0.4em]">per night</span>
                                        </div>
                                        
                                        <p class="text-slate-500 font-light line-clamp-2 mb-12 flex-grow leading-relaxed italic text-lg"><?php echo e($room->description); ?></p>
                                        
                                        <a href="<?php echo e(route('rooms.show', $room)); ?>" class="block w-full text-center bg-slate-50 group-hover:bg-navy text-navy group-hover:text-gold py-6 rounded-2xl font-bold uppercase tracking-[0.4em] transition-all duration-700 text-[10px] border border-slate-100">
                                            Discover Suite
                                        </a>
                                    </div>
                                </div>
                    ...
                    <?php $__currentLoopData = $galleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="splide__slide">
                            <div class="relative h-[500px] w-full group overflow-hidden">
                                <img src="<?php echo e(asset('images/' . $image->image_path)); ?>" 
                                ...
                                <div class="absolute bottom-10 left-10 opacity-0 group-hover:opacity-100 transition-all duration-700 transform translate-y-4 group-hover:translate-y-0">
                                    <h4 class="text-white font-serif font-bold text-2xl italic tracking-wider"><?php echo e($image->title); ?></h4>
                                </div>
                            </div>
                        </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="space-y-6" x-data="{ active: null }">
                ...
                <?php $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden transition-all duration-300">
                        <button 
                            @click="active !== <?php echo e($i); ?> ? active = <?php echo e($i); ?> : active = null"
                            class="w-full px-10 py-10 flex items-center justify-between text-left group">
                            <span class="text-xl font-serif font-bold text-navy group-hover:text-gold transition-colors"><?php echo e($faq['q']); ?></span>
                            <div class="w-10 h-10 rounded-full border border-slate-200 flex items-center justify-center text-slate-400 group-hover:bg-gold group-hover:text-white transition-all transform"
                                 :class="active === <?php echo e($i); ?> ? 'rotate-180 bg-gold text-white border-gold' : ''">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sallpat\resources\views/home.blade.php ENDPATH**/ ?>